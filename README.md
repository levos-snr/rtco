...
1. Using this repository as template
   ...
   ![use-this-template-button](https://github.com/ssets/76774237/f25c9a29-41de-4865-aa38-c032b9346169)

2. Using `create-next-app`

   ```bash
   npx create-next-app -e giturl my-project-name
   ```
